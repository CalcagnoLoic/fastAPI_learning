...
# 1. On met à jour cette route en utilisant un modèle. On définit la structure de la réponse JSON via Pydantic
...
#2. On met à jour la fonction de recherche
